        ...
        async function fetchUserInfoList() {
            ...
            tbody.innerHTML = '<tr><td colspan="8" class="p-8 text-center text-slate-500">데이터를 불러오는 중입니다...</td></tr>';
            ...
            if (error) {
                ...
                tbody.innerHTML = '<tr><td colspan="8" class="p-8 text-center text-red-500">데이터를 불러오는데 실패했습니다.</td></tr>';
                return;
            }
